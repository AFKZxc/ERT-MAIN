...
local creds = window:Tab("Copy the module family",'16060333448')

local credits = creds:section("『Anli Script』",true)
    credits:Button("copy Module",function()
    setclipboard("Please enter")
end)
    credits:Button("copy Module",function()
    setclipboard("Please enter")
end)
    credits:Button("copy Module2",function()
    setclipboard("Please enter")
end)
...
local credits = creds:section("跟踪脚本系列",true)
    credits:Button("老外跟踪1『不用自己打字搜索旁边有可以选择玩家』",function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Infinity2346/Tect-Menu/main/Teleport%20Gui.lua'))()
end)
    credits:Button("Anli的跟踪玩家『需要自己搜索，每次跟踪都要点击』",function()
    loadstring(game:HttpGet("https://"))()
end)
    credits:Button("老外跟踪脚本2『需要自己搜索，但是点击后就不用点击了，只不过不能移动，需要变小建议找Anli』",function()
...
local credits = creds:section("通用脚本",true)
    ...
    credits:Button("飞车『Anli』",function()
    loadstring(game:HttpGet("https://shz.al/~KISJS"))()
end)
    credits:Button("Anli甩飞",function()
    loadstring(game:HttpGet("https://"))()
end)
...
local creds = window:Tab("Anli汉化阿尔宙斯v3脚本",'16060333448')

local credits = creds:section("『Anli Script』",true)
    credits:Button("阿尔宙斯瞄准机器人",function()
    loadstring(game:HttpGet(""))()
end)
    credits:Button("阿尔宙斯飞行『推荐用这个飞行』",function()
    loadstring(game:HttpGet("https://shz.al/~KKDKS"))()
end)
    credits:Button("电脑端ESP『找不Fates ESP所以用这个绘制替代』",function()
    loadstring(game:HttpGet("https://shz.al/~MMSJS"))()
end)
    credits:Button("另一种esp",function()
    loadstring(game:HttpGet("https://cdn.wearedevs.net/scripts/WRD%20ESP.txt"))()
end)
    credits:Button("infinite-Yield",function()
...
local credits = creds:section("作者脚本",true)
    ...
    credits:Button("鸭hub『鸭不更了Anli来』",function()
    loadstring(game:HttpGet("https://"))()
end)
...
local credits = creds:section("电脑端脚本",true)
    credits:Button("电脑端的",function()
    loadstring(game:HttpGet("https://shz.al/~jxjzj"))()
end)
    credits:Button("Anli另一个手机端脚本（二改的）",function()
    loadstring(game:HttpGet("https://"))()
end)
...
local credits = creds:section("HUB脚本",true)
    ...
    credits:Button("Owl-Hub",function()
...
local creds = window:Tab("FE脚本『每过几天更新几个』",'16060333448')
...
local credits = creds:section("自制为云脚本ui",true)
    ...
    credits:Button("Anli力量传奇（来源白貓）",function()
...
local credits = creds:section("自制为云ui",true)
    credits:Button("Anli自制极速传奇",function()
...
local credits = creds:section("『Anli Script』",true)
    credits:Button("Anli忍者传奇（来源白貓）",function()
...
local credits = creds:section("Anli嘿",true)
...
local credits = creds:section("自制为云ui",true)
    credits:Button("Anli自制自然灾害",function()
...
local creds = window:Tab("杀手与警长",'16060333448')

local credits = creds:section("『Anli Script』",true)
    credits:Button("杀手与警长（找的）",function()
...
local creds = window:Tab("刀刃球（两天差不多更新一次但大部分都是电脑的）",'16060333448')

local credits = creds:section("『Anli Script』（听说的战场）",true)
    credits:Button("Anli汉化刀刃球",function()
    loadstring(game:HttpGet("https://"))()
end)
...
local credits = creds:section("『AnliI Script』",true)
...
local credits = creds:section("『Anli Script』",true)
    credits:Button("AnliBF",function()
    ...
    credits:Button("BF（Anli找的）",function()
...
local credits = creds:section("『Anli Script』",true)
    ...
    credits:Button("非常推荐（破坏者谜团2）",function()
...
local credits = creds:section("『Anli Script』",true)
    credits:Button("my简易汉化",function()
    loadstring(game:HttpGet("https://"))()
end)
...
local credits = creds:section("『Anli Script』（最强只是听说）",true)
...
local credits = creds:section("『Anli Script』",true)
    credits:Button("Anli出品必属精品",function()
    loadstring(game:HttpGet("https://"))()
end)
...
local credits = creds:section("『Anli Script』",true)
    credits:Button("寻宝模拟器『Anli汉化』",function()
